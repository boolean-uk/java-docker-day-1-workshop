...
The line beginning `FROM` specifies that we are going to use the Microsoft JDK base image for our container, this is one that has Java 21 installed into it already.
